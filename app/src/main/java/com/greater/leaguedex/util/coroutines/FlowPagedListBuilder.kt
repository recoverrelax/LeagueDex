package com.greater.leaguedex.util.coroutines

/*
 * Copyright $year Onsalesit, S.A.
 *
...
class FlowPagedListBuilder<K, V>(
    ...
    private var notifyDispatcher: CoroutineDispatcher = Dispatchers.Main.immediate,
    private var queryDispatcher: CoroutineDispatcher = Dispatchers.IO
) {
    /**
            ...
            private fun createPagedList(): PagedList<V> {
                do {
                    ...
                    val list = PagedList.Builder(dataSource!!, config)
                        ...
                        .setFetchExecutor(queryDispatcher.asExecutor())
